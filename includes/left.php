<div class="profile bgcolor-green noPrint">
	<div class="profile-img">
		<img src="<?= $configSite?><?=$themePathSite?>../Themes/sistema/images/users/autor.jpg" alt="Imagem do Usuário" title="Imagem do Usuário">
	</div>	
</div>

<div class="users bgcolor-green noPrint">
	<p class="font-text-sub text-center color-white">Jeferson Caminhões</p>
</div>
